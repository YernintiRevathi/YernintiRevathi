...
Engineer working across full-stack development and applied ML/computer vision.
...
- 📊 750+ DSA problems solved, 650+ day LeetCode streak
...
**[StayInn – Full-Stack Property Rental Platform](https://github.com/YernintiRevathi/styinn-rental)**
Full-stack rental marketplace with RESTful listings/reviews, session-based auth, owner-restricted authorization, Cloudinary image uploads, and MapTiler geocoding with interactive map display for listing locations.
...
**ML/CV:** Scikit-learn · TensorFlow · OpenCV · CNNs
